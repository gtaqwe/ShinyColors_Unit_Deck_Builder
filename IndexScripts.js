    ...
    for (var typeIdx = 0; typeIdx < type_list.length; typeIdx++) {
        ...
        for (var i = 0; i < cardLen; i++) {
            ...
            $("#" + cardList[i]["card_addr"]).click(function () {
                var selDivId = "#selectedIdolView_" + offset
                $(selDivId).html($('<img>',
                    {
...
function captureScreen(frameId) {
    var captureName = "Deck.png";
